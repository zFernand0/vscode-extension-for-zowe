...
export function createJesApi(profile: IProfileLoaded) {
...
export function createMvsApi(profile: IProfileLoaded) {
...
export function createUssApi(profile: IProfileLoaded) {
